...
void BulkinTexture::load(vk::Device& device, vk::PhysicalDevice& physicalDevice, vk::CommandPool& commandPool, vk::Queue& graphicsQueue) {
  ...
  Bulkin::createImage(texWidth, texHeight, vk::Format::eR8G8B8A8Srgb, vk::ImageTiling::eOptimal, vk::ImageUsageFlagBits::eTransferDst | vk::ImageUsageFlagBits::eSampled, vk::MemoryPropertyFlagBits::eDeviceLocal, device, physicalDevice, image, imageMemory, mipLevels);
  ...
  generateMipmaps(image, static_cast<uint32_t>(texWidth), static_cast<uint32_t>(texHeight), mipLevels, device, commandPool, graphicsQueue);
  
  //Bulkin::transitionImageLayout(device, commandPool, graphicsQueue, vk::Format::eR8G8B8A8Srgb, vk::ImageLayout::eTransferDstOptimal, vk::ImageLayout::eShaderReadOnlyOptimal, image, mipLevels);
...
void BulkinTexture::generateMipmaps(vk::Image image, int32_t texWidth, int32_t texHeight, uint32_t mipLevels, vk::Device& device, vk::CommandPool& commandPool, vk::Queue& graphicsQueue) {
  auto commandBuffer = BulkinBuffer::beginSingleTimeCommands(device, commandPool);
